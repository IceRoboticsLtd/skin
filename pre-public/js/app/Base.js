 ...
 */
define(function () {
    console.log('SKIN: mainBase called');
    ...
    mainBase.prototype = {
        setLib: function(lib) {
        	console.log('SKIN: mainBase setLib(lib) called');
        	this.lib = lib;
        },
        setConfig: function(config) {
        	console.log('SKIN: mainBase setConfig(config) called');
        	this.config = config;
        },
        setController: function(controller) {
        	console.log('SKIN: mainBase setController(controller) called');
        	this.controller = controller;
        },
        setStoreName: function(storeName) {
        	console.log('SKIN: mainBase setStoreName(storeName) called: storeName =');
        	console.log(storeName);
        	this.storeName = storeName;
        },  
        setElementId: function(elementId) {
        	console.log('SKIN: mainBase setElementId(elementId) called: elementId =');
        	console.log(elementId);
        	this.elementId = elementId;
        }, 
        setApp: function(app) {
        	console.log('SKIN: mainBase setApp(app) called');
        	this.app = app;
        },
        setAppController: function(appController) {
        	console.log('SKIN: mainBase setAppController(appController) called');
        	this.appController = appController;
        },
        setAppEvent: function(appEvent) {
        	console.log('SKIN: mainBase setAppEvent(appEvent) called');
        	this.appEvent = appEvent;
        },
        setAppService: function(appService) {
        	console.log('SKIN: mainBase setAppService(appService) called');
        	this.appService = appService;
        },
        setServiceBus: function(serviceBus) {
        	console.log('SKIN: mainBase setServiceBus(serviceBus) called');
        	this.serviceBus = serviceBus;
        },
        setView: function(view) {
        	console.log('SKIN: mainBase setView(view) called');
        	this.view = view;
        },
        setViewController: function(viewController) {
        	console.log('SKIN: mainBase setViewController(viewController) called');
        	this.viewController = viewController;
        },
        setViewService: function(viewService) {
        	console.log('SKIN: mainBase setViewService(viewService) called');
        	this.viewService = viewService;
        },
        setViewEvent: function(viewEvent) {
        	console.log('SKIN: mainBase setViewEvent(viewEvent) called');
        	this.viewEvent = viewEvent;
        },
        setViewIndex: function(viewIndex) {
        	console.log('SKIN: mainBase setViewIndex(viewIndex) called');
        	this.viewIndex = viewIndex;
        },
        loadView: function(viewIndex) {
        	console.log('SKIN: mainBase loadView(viewIndex) called');
        	this.controller.loadView(viewIndex);
        },
        renderView: function(elementId) {
        	console.log('SKIN: mainBase renderView(elementId) called');
        	this.controller.renderView(elementId);
        },
        readyController: function(me, callback) {
        	console.log('SKIN: mainBase readyController(me, callback) called');
        	var err = null;
			if(typeof me.controller === 'undefined') {
				me.require(['../app/controller/controller'], function (controller) {
                    console.log('SKIN: mainBase: controller required');
        ...
        readyConfig: function(me, callback) {
        	console.log('SKIN: mainBase readyConfig(me, callback) called');
        	var err = null;
			if(typeof me.config === 'undefined') {
				me.require(['../app/config/config'], function (config) {
                    console.log('SKIN: mainBase: config required');
                    console.log(config);
                    me.config = config; 
        ...
        readyServiceBus: function(me, callback) {
        	console.log('SKIN: mainBase readyServiceBus(me, callback) called');
        	var err = null;
			if(typeof me.serviceBus === 'undefined') {
				me.require(['../app/serviceBus/serviceBus'], function (serviceBus) {
                    console.log('SKIN: mainBase: serviceBus required');
        ...
        readyAppController: function(me, callback) {
        	console.log('SKIN: mainBase readyAppController(me, callback) called');
        	var err = null;
			if(typeof me.appController === 'undefined') {
				me.require(['../app/appController/appController'], function (appController) {
                    console.log('SKIN: mainBase: appController required');
        ...
        readyAppService: function(me, callback) {
        	console.log('SKIN: mainBase readyAppService(me, callback) called');
        	var err = null;
			if(typeof me.appService === 'undefined') {
				me.require(['../app/appService/appService'], function (appService) {
                    console.log('SKIN: mainBase: appService required');
        ...
        readyApp: function(me, callback) {
        	console.log('SKIN: mainBase readyApp(me, callback) called');
        	var err = null;
			if(typeof me.app === 'undefined') {
				me.require(['../app/app/app'], function (app) {
                    console.log('SKIN: mainBase: app required');
                    console.log(app);
                    me.app = app; 
        ...
        readyAppEvent: function(me, callback) {
        	console.log('SKIN: mainBase readyAppEvent(me, callback) called');
        	var err = null;
			if(typeof me.appEvent === 'undefined') {
				me.require(['../app/appEvent/appEvent'], function (appEvent) {
                    console.log('SKIN: mainBase: appEvent required');
        ...
        readyViewController: function(me, callback) {
        	console.log('SKIN: mainBase readyViewController(me, callback) called');
        	var err = null;
			if(typeof me.viewController === 'undefined') {
				me.require(['../app/viewController/viewController'], function (viewController) {
                    console.log('SKIN: mainBase: viewController required');
        ...
        readyViewService: function(me, callback) {
        	console.log('SKIN: mainBase readyViewService(me, callback) called');
        	var err = null;
			if(typeof me.viewService === 'undefined') {
				me.require(['../app/viewService/viewService'], function (viewService) {
                    console.log('SKIN: mainBase: viewService required');
        ...
        readyView: function(me, callback) {
        	console.log('SKIN: mainBase readyView(me, callback) called');
        	var err = null;
			if(typeof me.view === 'undefined') {
				me.require(['../app/view/view'], function (view) {
                    console.log('SKIN: mainBase: view required');
                    console.log(view);
                    me.view = view; 
        ...
        readyViewEvent: function(me, callback) {
        	console.log('SKIN: mainBase readyViewEvent(me, callback) called');
        	var err = null;
			if(typeof me.viewEvent === 'undefined') {
				me.require(['../app/viewEvent/viewEvent'], function (viewEvent) {
                    console.log('SKIN: mainBase: viewEvent required');
        ...
        ready: function() {
        	console.log('SKIN: mainBase ready() called');
        	var me = this; // contains the current context
        	// Controller
        	me.readyController(me, function(me, err, controller) {
        		if(err) {
        			console.log('SKIN: mainBase readyController error:');
        			console.log(err);
        		}
        		else {
        			console.log('SKIN: mainBase ready controller:');
        			console.log(controller);
        			me.controller = controller;
					// Set storeName
				    console.log('SKIN: mainBase ready me.controller.setStoreName(me.storeName):');
					// StoreName
					...
					me.readyConfig(me, function(me, err, config) {
						if(err) {
							console.log('SKIN: mainBase readyConfig error:');
							console.log(err);
						}
						else {
							console.log('SKIN: mainBase ready config:');
							console.log(config);
							me.config = config;
							// Set config
							console.log('SKIN: mainBase ready me.controller.setConfig(me.config):');
							// Config
							if(typeof me.config === 'undefined') {
								me.config = {}; // default
								console.log(me.config);
							...
							me.readyServiceBus(me, function(me, err, serviceBus) {
								if(err) {
									console.log('SKIN: mainBase readyServiceBus error:');
									console.log(err);
								}
								else {
									console.log('SKIN: mainBase ready serviceBus:');
									console.log(serviceBus);
									me.serviceBus = serviceBus;
									// Set serviceBus
									console.log('SKIN: mainBase ready me.controller.setServiceBus(me.serviceBus):');
									// ServiceBus
									if(typeof me.serviceBus === 'undefined') {
									...
									me.readyAppController(me, function(me, err, appController) {
										if(err) {
											console.log('SKIN: mainBase readyAppController error:');
											console.log(err);
										}
										else {
											console.log('SKIN: mainBase ready appController:');
											console.log(appController);
											me.appController = appController;
											// Set appController
											console.log('SKIN: mainBase ready me.controller.setAppController(me.appController):');
											// AppController
											if(typeof me.appController === 'undefined') {
											...
											me.readyAppService(me, function(me, err, appService) {
												if(err) {
													console.log('SKIN: mainBase readyAppService error:');
													console.log(err);
												}
												else {
													console.log('SKIN: mainBase ready appService:');
													console.log(appService);
													me.appService = appService;
													// Set appService
													console.log('SKIN: mainBase ready me.controller.setAppService(me.appService):');
													// AppService
													if(typeof me.appService === 'undefined') {
													...
													me.readyApp(me, function(me, err, app) {
														if(err) {
															console.log('SKIN: mainBase readyApp error:');
															console.log(err);
														}
														else {
															console.log('SKIN: mainBase ready app:');
															console.log(app);
															me.app = app;
															// Set app
															console.log('SKIN: mainBase ready me.controller.setApp(me.app):');
															// App
															if(typeof me.app === 'undefined') {
																me.app = {}; // default
																console.log(me.app);
															...
															me.readyAppEvent(me, function(me, err, appEvent) {
																if(err) {
																	console.log('SKIN: mainBase readyAppEvent error:');
																	console.log(err);
																}
																else {
																	console.log('SKIN: mainBase ready appEvent:');
																	console.log(appEvent);
																	me.appEvent = appEvent;
																	// Set appEvent
																	console.log('SKIN: mainBase ready me.controller.setAppEvent(me.appEvent):');
																	// AppEvent
																	if(typeof me.appEvent === 'undefined') {
																		me.appEvent = {}; // default
																		console.log(me.appEvent);
																	...
																	console.log('SKIN: mainBase ready this.controller.subscribeAppService()');			    
									...
									me.readyViewController(me, function(me, err, viewController) {
										if(err) {
											console.log('SKIN: mainBase readyViewController error:');
											console.log(err);
										}
										else {
											console.log('SKIN: mainBase ready viewController:');
											console.log(viewController);
											me.viewController = viewController;
											// Set viewController
											console.log('SKIN: mainBase ready me.controller.setViewController(me.viewController):');
											// ViewController
											if(typeof me.viewController === 'undefined') {
											...
											me.readyViewService(me, function(me, err, viewService) {
												if(err) {
													console.log('SKIN: mainBase readyViewService error:');
													console.log(err);
												}
												else {
													console.log('SKIN: mainBase ready viewService:');
													console.log(viewService);
													me.viewService = viewService;
													// Set viewService
													console.log('SKIN: mainBase ready me.controller.setViewService(me.viewService):');
													// ViewService
													if(typeof me.viewService === 'undefined') {
													...
													me.readyView(me, function(me, err, view) {
														if(err) {
															console.log('SKIN: mainBase readyView error:');
															console.log(err);
														}
														else {
															console.log('SKIN: mainBase ready view:');
															console.log(view);
															me.view = view;
															// Set view
															console.log('SKIN: mainBase ready me.controller.setView(me.view):');
															// View
															if(typeof me.view === 'undefined') {
																me.view = {}; // default
																console.log(me.view);
															...
															me.readyViewEvent(me, function(me, err, viewEvent) {
																if(err) {
																	console.log('SKIN: mainBase readyViewEvent error:');
																	console.log(err);
																}
																else {
																	console.log('SKIN: mainBase ready viewEvent:');
																	console.log(viewEvent);
																	me.viewEvent = viewEvent;
																	// Set viewEvent
																	console.log('SKIN: mainBase ready me.controller.setViewEvent(me.viewEvent):');
																	// ViewEvent
																	if(typeof me.viewEvent === 'undefined') {
																	...
																	console.log('SKIN: mainBase ready me.controller.subscribeViewService()');			    
				    												me.controller.subscribeViewService();
				    												// LoadView, before renderView
                                                                    console.log('SKIN: mainBase ready me.controller.loadView(viewIndex):')
                                                                    // ViewIndex
                                                                    ...
                                                                    console.log('SKIN: mainBase ready me.controller.renderView(elementId):'); 
                                                                    // ElementId
